                ...
                <div class="col-md-12 stretch-card grid-margin grid-margin-md-0 " >
                  <div class="card data-icon-card" style="background-color:#181f39 ">
                    <div class="card-body">
                        ...
                        <a href="beneficiary" style="text-decoration: none;" class="text-center">          
                          <div class="row">
                             <div class="col-12 text-white text-center" style=" padding-right: 1em;">
                               <h3> عـدد المسـتـفـيـديـن</h3>
                          ...
                          <div class="card-body">
                            ...
                            <a href="mediator" style="text-decoration: none; " class="text-center">                       
                              ...
                              <div class="col-12 text-white text-center" style="padding-right: 0.9em;">
                                ...
                                <h2 class="text-white font-weight-500 mb-0 " > {{ $med }} </h2>
                              </div>
                              {{-- <div class="col-4 background-icon" >
                              </div> --}}
                            </div>
                      ...
                      <div class="card-body">
                        ...
                        <a href="donation" style="text-decoration: none; " class="text-center">                       
                          ...
                          <div class="col-12 text-white text-center" style="padding-right: 0.9em;">
                            ...
                            <h2 class="text-white font-weight-500 mb-0 " > {{ $donation }} </h2>
                          </div>
                          {{-- <div class="col-4 background-icon" >
                          </div> --}}
                        </div>
                      ...
                      <div class="col-md-12 stretch-card grid-margin grid-margin-md-0 " >
                        <div class="card data-icon-card" style="background-color:#181f39 ">
                          <div class="card-body">
                            ...
                            <a href={{ url('getAllRes') }} style="text-decoration: none; " class="text-center">                       
                              <div class="row text-center">
                              <div class="col-12 text-white text-center" style="padding-right: 0.9em;">
                                <h3 > عـدد التبرعات  المحجوزة</h3>
                                <h2 class="text-white font-weight-500 mb-0 " > {{ $rev }} </h2>
                              </div>
                              {{-- <div class="col-4 background-icon" >
                              </div> --}}
                            </div>
                      ...
                      <div class="col-md-12 stretch-card grid-margin grid-margin-md-0 " >
                        <div class="card data-icon-card" style="background-color:#181f39 ">
                          <div class="card-body">
                            ...
                            <a href={{ url('getAllNotRes') }} style="text-decoration: none; " class="text-center">                       
                              <div class="row text-center">
                              <div class="col-12 text-white text-center" style="padding-right: 0.9em;">
                                <h3 > عـدد التبرعات الغير المحجوزة</h3>
                                <h2 class="text-white font-weight-500 mb-0 " > {{ $notRev }} </h2>
                              </div>
                              {{-- <div class="col-4 background-icon" >
                              </div> --}}
                            </div>
