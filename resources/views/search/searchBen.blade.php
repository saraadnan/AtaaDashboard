      ...
      <button type="button" class="btn " id ="button_add_donors" >  اضـافـة مـسـتـفيـد</button>
        ...
        <div class="table "  style="width: 50em">
          <table id="datatable" class="table table-striped table-borderless" >
            ...
            <tbody >
              <tr>
                <td style="font-size: 1em" class="tben_id" > {{ $beneficiary->id }}</td>
                <td class="font-weight-bold tben_name" style="font-size:  1em">{{ $beneficiary->ben_name }}</td>
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <form action="{{ url('editben') }}" method="POST" id="editForm">
                  @csrf
                  <input type="hidden" name="ben_id" :value="$beneficiary->id" id="ben_id">
                  ...
                  <select class="form-control" name="neigh_id" required>
                      ...
                      @foreach ($neighborhood as $neighborhood ) 
                        ...
                        <option value="{{ $neighborhood->id }}" style="font-size: 1.2em">
