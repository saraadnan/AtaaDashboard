      ...
      <button type="button" class="btn " id ="button_add_donors" >  اضـافـة مديريـة</button>
        ...
        <div class="table-responsive">
          <table id="datatable" class="table table-striped table-borderless">
            ...
            <tbody >
              <tr>
                <td style="font-size: 1em" class="tdir_id"> {{ $directorate->id }}</td>
                ...
                <td> 
                   ...
                   <a href={{ "deleteDir/".$directorate['id'] }}>  <button type="button" class="btn btn-danger" style="font-weight: bolder; font-size: 1em">حـذف</button></a> 
                   <button type="button" class="btn editbtn" wire:click="editgov{{ $directorate->id  }}"  data-toggle="modal"  data-target="#editModal" style="font-weight: bolder; font-size: 1em" value="{{ $directorate->id }}" >تـعـديـل</button> 
      ...
      <div class="modal-content clearfix">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <form action="{{ url('editdir') }}" method="POST" id="editForm">
                  @csrf
                  <input type="hidden" name="dir_id" :value="$directorate->id" id="dir_id">
          ...
          {{-- <input type="text" class="form-control" name="gov_id" :value="$governorates->id" id="gov_id" placeholder="رقـم المحافظـة" style="font-size: 1.1em " readonly> --}}
                ...
                <select  class="form-control" name="gov_id" id="gov_id">
                  ...
                  <option  class="form-control"  placeholder=" اسـم المحافظـة" style="font-size: 1.1em " value="{{ $governorate->id }}">
