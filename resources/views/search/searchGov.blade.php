          ...
          <!-- نهاية الرسالة -->
              ...
              <div class="table-responsive">
                <table id="datatable" class="table table-striped table-borderless">
                  ...
                  <tbody >
                    <tr>
                      <td style="font-size: 1em" class="tgov_id">  {{ $governorate->id }}</td>
                      <td class="font-weight-bold tgov_name" style="font-size:  1em" >{{ $governorate->gov_name }}</td>
                      <td>
                       
                        <a href={{ "deleteGov/".$governorate['id'] }}> <button type="button" class="btn btn-danger" style="font-weight: bolder; font-size: 1em">حـــذف</button></a> 
                         <button type="button" class="btn editbtn" wire:click="editgov{{ $governorate->id  }}"  data-toggle="modal"  data-target="#editModal" style="font-weight: bolder; font-size: 1em" value="{{ $governorate->id }}" >تـعـديـل</button> 
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            <form action="{{ url('editgov') }}" method="POST" id="editForm">
                              @csrf
                              {{-- <input type="hidden" name="gov_id" :value="$governorates->id" id="gov_id"> --}}
