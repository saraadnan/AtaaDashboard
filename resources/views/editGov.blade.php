          ...
          <div class="col-md-6 grid-margin stretch-card col-lg-6 " >
             <div class="card">
                 <div class="card-body" >
                    ...
                    <form class="forms-sample" method="POST" action="{{ url('/editGov') }}" >
                      @csrf
              ...
              <input type="text" class="form-control" name="gov_name" value="{{ $governorate['gov_name'] }}" id="govName" placeholder="اسم المحافظـة" style="font-size: 1.1em ">
            </div>
