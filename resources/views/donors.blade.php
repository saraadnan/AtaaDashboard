...
<div class="row col-lg-9" style="margin-right: 2em">
          ...
          <table id="datatable" class="table table-striped table-borderless">
            <thead>
              <tr >
                ...
                <th style="font-size:  1em">اسـم المتبـرع </th>
            ...
            <tbody >
              <tr>
                <td style="font-size: 1em" class="tdonor_id"> {{ $user->id }}</td>
                <td class="font-weight-bold tdonor_name" style="font-size:  1em">{{ $user->name }}</td>
                {{-- <td class="font-weight-bold tdonor_lname" style="font-size:  1em">{{ $donor->donor_last_name }}</td> --}}
                <td>
                 
                  <a href={{ "deleteDonor/".$user['id'] }}> <button type="button" class="btn btn-danger" style="font-weight: bolder; font-size: 1em">حـذف</button></a> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content clearfix">
            ...
            {{-- <input type="text" class="form-control" name="gov_id" :value="$governorates->id" id="gov_id" placeholder="رقـم المحافظـة" style="font-size: 1.1em " readonly> --}}
                   ...
                   <label for="name" style="font-size: 1.2em ; padding-bottom: 1%"  > اسـم  المتبـرع</label>
  ...
  <script>
    ...
    $(document).on('click','.editbtn', function (e) {
     ...
     $('#id').val(_this.find('.tdonor_id').text());
     $('#name').val(_this.find('.tdonor_name').text());
