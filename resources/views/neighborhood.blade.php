      ...
      <button type="button" class="btn " id ="button_add_donors" >  اضـافـة حــي</button>
        ...
        <div class="table-responsive">
          <table id="datatable" class="table table-striped table-borderless">
            ...
            <tbody >
              <tr>
                <td style="font-size: 1em" class="tneigh_id"> {{ $neighborhood->neigh_id }}</td>
                ...
                <td> 
                   ...
                   <a href={{ "deleteNeigh/".$neighborhood['neigh_id'] }}>  <button type="button" class="btn btn-danger" style="font-weight: bolder; font-size: 1em">حـذف</button></a> 
                   <button type="button" class="btn editbtn" wire:click="editgov{{ $neighborhood->neigh_id  }}"  data-toggle="modal"  data-target="#editModal" style="font-weight: bolder; font-size: 1em" value="{{ $neighborhood->neigh_id }}" >تـعـديـل</button> 
 ...
 <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModelLabel">
  <div class="modal-dialog" role="document">
      <div class="modal-content clearfix">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <form action="{{ url('editneigh') }}" method="POST" id="editForm">
                  @csrf
                  <input type="hidden" name="neigh_id" :value="$neighborhood->neigh_id" id="neigh_id">
          ...
          <label for="dir_id" style="font-size: 1.2em ; padding-bottom: 1% ; padding-right: 0%"> المحـافـظـة </label> 
