              ...
              <div class="table-responsive">
                <table class="table table-striped text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="tdonation_id">{{ $donation->donation_id }}
                      </td>
                      <td class="tcat_id">{{ $donation->category->cat_name }}
                      </td>
                      <td class="py-1 tdonation_image"> <img src="{{ $donation->image }}" alt="image"/>

                      </td>
                      <td class="tdonation_title"> {{ $donation->donation_title }}
                      </td>
                      <td class="tdonation_desc">{{ $donation->donation_desc }}

                      </td>
                      <td class="tdonation_quantity">{{ $donation->donation_quantity }}
                      </td>

                      <td class="tdonation_quantity"> {{ $donation->res_quantity }}
                      </td>
                      @if( $donation->category->cat_id ==2)
                      <td class="tdonation_exp">{{ $donation->donation_exp }}
                      </td>
                     @else
                    ...
                    @endif
                      ...
                      <td class="tdir_id">{{ $donation->directorate->dir_name}}
                      </td>
                      <td class="tdelivery_place"> {{ $donation->delivery_place}}
                      </td>
                      <td class="tdelivery_time">{{ $donation->delivery_time}}

                      </td>
                      <td class="tuser_name"> {{ $donation->user->name}}

                      </td>
                      <td class=" tuser_id" style="display: none" > {{ $donation->user->id }} 
                      </td>
...
<br>
          ...
          <select class="form-control" name="donation_dir" required>
            ...
            {{-- <label for="notes" style="font-size: 1.2em ; padding-bottom: 1%"  > مكـان التسليـم</label> 
            <input type="text" class="form-control" name="notes" id="notes" placeholder="مكـان التسليـم" style="font-size: 1.1em "  required>
                 <!-- رسالة التحقق من صحة البيانات المضافة -->
                     @error('donation_quantity')
                     <span class="text-danger"> {{ $message }}</span>
...
<script>
  ...
  // $('#notes').val(_this.find('.notes').text());
